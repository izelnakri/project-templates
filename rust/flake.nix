# NOTE: Move all rustc and cargo references to rustToolchain after github actions run, compare duration of diff runs
{
  description = "GitHub User Fetcher - Example Complex rust binary & library that uses external dependencies & tools";
