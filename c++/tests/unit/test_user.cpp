...
TEST_CASE("fetch_github_user returns valid user for known GitHub account", "[fetch_github_user]") {
...
TEST_CASE("fetch_github_user throws for nonexistent username", "[fetch_github_user]") {
