...
User fetch_github_user(const char *username) {
    ...
    if (json_is_string(login)) strncpy(user.login, json_string_value(login), sizeof(user.login));
    if (json_is_string(name)) strncpy(user.name, json_string_value(name), sizeof(user.name));
    if (json_is_string(company)) strncpy(user.company, json_string_value(company), sizeof(user.company));
    if (json_is_string(location)) strncpy(user.location, json_string_value(location), sizeof(user.location));
